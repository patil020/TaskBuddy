...
public class TaskController {
    ...
    // Update task status (e.g., ACCEPTED/REJECTED/IN_PROGRESS/DONE) - only assignee can do this
    ...
    public ResponseEntity<ApiResponse<?>> deleteTask(
        ...
        return ResponseEntity.ok(response); // keeping your 200 OK contract
        // Tip: You could return 204 No Content for pure deletes.
    }
}
